...
# -----------
# Output Format:
# - Rationale: A clear and concise explanation of why the new response is "ACCEPT" or "REJECT".
# - Result: "ACCEPT" if the new response is equivalent or better, or "REJECT" if it is not. This should be a single word between "ACCEPT" and "REJECT" with no additional formatting.
# -----------
# - Old response: {old_response}
# - New response: {new_response}
# - Rationale:
...
# -----------
# Output Format:
# - Rationale: A clear and concise explanation of why the new response is "ACCEPT" or "REJECT". This should be a single string with no additional formatting.
# - Result: "ACCEPT" if the SME feedback is fully incorporated, or "REJECT" if it is not. This should be a single word between "ACCEPT" and "REJECT" with no additional formatting.
# -----------
# - Old response: {old_response}
# - SME feedback: {sme_feedback}
# - New response: {new_response}
